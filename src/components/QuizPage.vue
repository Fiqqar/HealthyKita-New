      ...
      <div class="content">
        <div class="quiz-card">
          ...
          <div class="question-text">
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magnam, saepe explicabo, asperiores earum
              debitis dicta voluptatum sed quos itaque provident commodi mollitia veritatis tenetur voluptates, quo
              necessitatibus! Mollitia, rerum deleniti.</p>
          </div>
          <div class="options">
