        ...
        <div class="notifications">
          ...
          <div class="section">
            <div class="notification-item">
              <div class="text">
                <strong>geenzxz, zadenhub</strong> and <strong>10 others</strong> liked your photo. <span
                  class="time">1d</span> - <span class="date-time">11:30 PM</span>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="notification-item">
              <div class="text">
                <strong>k_photographs10</strong> started following you. <span class="time">2d</span> - <span
                  class="date-time">11:30 PM</span>
              </div>

            </div>
            <div class="notification-item">
              <div class="text">
                <strong>prometheus.zk, renjesaldama</strong> and <strong>scorpionwwr</strong> liked your story. <span
                  class="time">3d</span> - <span class="date-time">11:30 PM</span>
              </div>
            </div>
            <div class="notification-item">
              <div class="text">
                <strong>websitemontana</strong> started following you. <span class="time">3d</span> - <span
                  class="date-time">11:30 PM</span>
              </div>
            ...
            <div class="notification-item">
              <div class="text">
                <strong>symphoniemonoton</strong> and <strong>arsyasven</strong> liked your photo. <span
                  class="time">4d</span> - <span class="date-time">11:30 PM</span>
              </div>
            </div>
            <div class="notification-item">
              <div class="text">
                <strong>ven.draw_, arsyasven</strong> and <strong>26 others</strong> liked your photo. <span
                  class="time">6d</span> - <span class="date-time">11:30 PM</span>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            <div class="notification-item">
              <div class="text">
                <strong>andighudzamir</strong> liked your story. <span class="time">1w</span> - <span
                  class="date-time">11:30 PM</span>
              </div>
            </div>
            <div class="notification-item">
              <div class="text">
                <strong>zadenhub, azraenits</strong> and <strong>11 others</strong> liked your photo. <span
                  class="time">1w</span> - <span class="date-time">11:30 PM</span>
              </div>
            </div>
            <div class="notification-item">
              <div class="text">
                <strong>andighudzamir, renjesaldama</strong> liked your story. <span class="time">1w</span> - <span
                  class="date-time">11:30 PM</span>
              </div>
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      isMenuOpen: false,
      message: "geenzxz liked your photo."
    };
  },
  methods: {
